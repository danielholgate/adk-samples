...
"""FastAPI application for Data Quality Agent.
...
if default_app:
    ...
    os.environ["ADK_DEFAULT_APP_NAME"] = "data_quality_agent"
...
app_args = {
    ...
    "extra_plugins": ["data_quality_agent.plugins.reflect_retry_plugin"],
}
...
app.title = "data_quality_agent"
app.description = "Data Quality Agent API"
